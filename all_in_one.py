...
out.to_csv('fuzy_nn_result_001.csv', index=None)

out = pd.DataFrame(c)
out.columns = ['params']
out.to_csv('params_001.csv', index=None)
...
res_001 = pd.read_csv('fuzy_nn_result_001.csv', index_col='id')
out = res_001
res_001['relevance'][res_001['relevance']>3] = 3
max(res_001['relevance'])


out = pd.DataFrame({'id': res_001.index, 'relevance': res_001.relevance})
out.to_csv('fuzy_nn_result_001.csv', index=None)
out = pd.DataFrame(c)
out.columns = ['params']
out.to_csv('params_001.csv', index=None)
...
out = pd.DataFrame({'id': test.id, 'relevance': y_test_model})
out.to_csv('fuzy_nn_result_0001.csv', index=None)

out = pd.DataFrame(c)
out.columns = ['params']
out.to_csv('params_0001.csv', index=None)
...
out = pd.DataFrame({'id': test.id, 'relevance': y_test_model})
out.to_csv('fuzy_nn_result_grad_001.csv', index=None)

out = pd.DataFrame(c)
out.columns = ['params']
out.to_csv('params_grad_001.csv', index=None)
